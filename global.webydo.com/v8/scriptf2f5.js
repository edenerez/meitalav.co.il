...
function UpdateStylesForNonParallaxBreakpoint(parallaxedElements) {
    if (parallaxedElements.length > 0) {
        ...
        parallaxedElements.each(function () {
            if (this.getAttribute('initbr') && this.getAttribute('initbr') != _currentBreakpoint) {
...
function LeftFix() {
    ...
    try {
        ...
        parallaxedElements.removeClass('show-parallax');
        parallaxedElements.each(function () {
            var parallaxIsActiveInCurrentBreakPoint = !this.getAttribute('initbr') || this.getAttribute('initbr') == _currentBreakpoint;
